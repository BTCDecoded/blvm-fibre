//! FIBRE wire format: chunk framing, checksums, and config types used by [`crate::relay::FibreRelay`].
//!
//! Lives in **`blvm-fibre`** so core P2P (`blvm-protocol`) stays free of FIBRE-specific deps.
